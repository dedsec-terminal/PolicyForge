...
- **Restricted data (digital):** MUST be cryptographically erased (crypto-shredding by destroying encryption keys) or overwritten using a NIST SP 800-88 Rev. 2 or DoD 5220.22-M compliant multi-pass wipe. Cloud storage resources containing Restricted data MUST be purged using the cloud provider's certified secure deletion mechanism before decommissioning.
