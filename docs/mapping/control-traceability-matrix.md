...
| AM-03 | access-management | Unique user IDs mandatory; shared/generic accounts prohibited | A.5.16 | PR.AA-02 | Req 8.2.1 | Sec 8(5) | - | Exception process references [Exception Log](#exception-log) | Confirmed |
...
| DC-09 | data-classification-handling | Production Restricted data prohibited in dev/test without CISO+Compliance approval, anonymization, and exception log entry | A.8.31 | PR.DS-01 | Req 3.3.2 | Sec 6, 8 | Art 25, 32 | Exception references [Exception Log](#exception-log) | Confirmed |
