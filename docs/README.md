...
| [Mapping](https://dedsec-terminal.github.io/PolicyForge/#ctm) | Control Traceability Matrix - ISO 27001, NIST CSF, PCI DSS, DPDP Act 2023, GDPR |
...
- **IR-06** (Incident Response) maps to **GDPR Art. 33/34** and **DPDP Act 2023 Sec 8(6)** for mandatory breach notification
